...
double LennardJones::getCoulombEnergy() const {
    return Coulomb::computeEnergy(positions, A); // Delegated to separate class
}

double LennardJones::getTotalEnergy() const {
